...
def ask_gpt(text, query):
    prompt = f"Is the following article both NOT ANYTHING LIKE AN AD, and very interesting and relevant to the search keyword of '{query}'? If so, reply only with YES. If not, reply only with NO. Be selective.\n\n{text}"
    try:
